...
[dates, newcases_hist, totalcases_hist] = readCSVData('../data.csv', 'Germany');

% the first cases seem controlled and should be excluded as a beginning of the epidemics
...
R0 = [linspace(12, 10, 15/h) linspace(10, 7.5, 14/h) linspace(5.5, 0.7, T/h+1-(28+25+horizon-detection_time)/h) linspace(0.7, 0.6, 19/h) linspace(0.6, 0.6, 5/h) ones(1,(horizon-detection_time)/h)*0.6];
